...
class FAQQuestionPagingSource(private val apiService: ApiServices) : PagingSource<Int, FAQQuestionResponse>() {
    companion object {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, FAQQuestionResponse> {
        return try {
            ...
            val response = apiService.getFAQQuestion(page = pageNo, perPage = PAGE_LIMIT)
