...
@Composable
fun AdvertisementSubscriptionScreen(
    navController: NavController,
    viewModel: AdvertisementSubscriptionViewModel = hiltViewModel(),
) {
    ...
    AppScaffold(
        ...
        AdvertisementSubscriptionScreenContent(uiState)
    }
...
@Composable
private fun AdvertisementSubscriptionScreenContent(
    uiState: AdvertisementUiState,
) {
    ...
    LaunchedEffect(Unit) {
        // Fetch advertisement click products from RevenueCat
        val productIds = Constants.Subscription.AdvertisementClickPlan.entries.map { it.productId }
...
val productIdToClicks = mapOf(
    "click_pack_50" to "50 Clicks",
    "click_pack_150" to "150 Clicks",
    "click_pack_300" to "300 Clicks",
    "click_pack_500" to "500 Clicks"
)
@Composable
private fun AdvertisementTierCard(product: StoreProduct, onClick: () -> Unit = {}) {
    val clicks = productIdToClicks[product.id]
    val cleanTitle = product.title.replace(" (Legacy Cache)", "")
    Log.d("TAG", "product.id: ${product.id},clicks:$clicks")
    Card(
        modifier = Modifier
            .fillMaxWidth(),
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Log.d("TAG", "AdvertisementTierCard: $clicks")
...
fun AboutScreenContentPreview() {
    val uiState = AdvertisementUiState()
    AdvertisementSubscriptionScreenContent(uiState)
}
