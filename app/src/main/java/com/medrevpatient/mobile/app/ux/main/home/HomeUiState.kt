...
sealed interface HomeUiEvent {
    ...
    data class ImageDisplay(val mediaList: List<com.medrevpatient.mobile.app.model.domain.response.container.legacyPost.Media>) :
        HomeUiEvent
    ...
    data class VideoPreviewClick(val mediaList: List<com.medrevpatient.mobile.app.model.domain.response.container.legacyPost.Media>) :
        HomeUiEvent
