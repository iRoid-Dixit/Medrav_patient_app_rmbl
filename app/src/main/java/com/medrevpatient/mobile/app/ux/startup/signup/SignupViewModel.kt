...
@Inject constructor(
    ...
    getSignupUiStateUseCase: GetSignupUiStateUseCase
) : ViewModel(), ViewModelNav by ViewModelNavImpl() {
    val uiState: SignupUiState = getSignupUiStateUseCase(context = context, coroutineScope = viewModelScope) { navigate(it) }
